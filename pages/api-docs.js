    ...
    <Layout>
      <main>
        ...
        <Container>
          ...
          <section>
            <h3 className="mb-4">Oracles Index<code className="block">GET /api/oracles/</code></h3>
            <p>Returns all oracle roll tables and their metadata.</p>
          </section>

          <section>
            <h3 className="mb-4">Single Oracle<code className="block">GET /api/oracles/[slug]</code></h3>
          ...
          <section>
            <h3 className="mb-4">Oracle Result<code className="block">GET /api/oracles/[slug]/[value]</code></h3>
          ...
          <section>
            <h3 className="mb-4">Oracle Roll<code className="block">GET /api/oracles/[slug]/random</code></h3>
